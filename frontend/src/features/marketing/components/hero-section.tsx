...
export function HeroSection() {
    return (
        <section className="mx-auto grid w-full max-w-295 items-center gap-12 px-6 pt-12 pb-16 lg:grid-cols-[0.94fr_1.06fr] lg:px-8 lg:pt-20 lg:pb-20" id="product">
            <div className="motion-safe:animate-marketing-rise">
                ...
                <h1 className="mt-6 max-w-145 text-[clamp(2.65rem,5.1vw,4.6rem)] leading-[1.04] font-bold tracking-[-0.055em] text-text-primary">
